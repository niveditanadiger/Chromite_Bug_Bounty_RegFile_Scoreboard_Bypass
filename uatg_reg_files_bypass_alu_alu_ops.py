...
class uatg_bypass_alu_alu_ops(IPlugin):
    ...
    def generate_asm(self) -> List[Dict[str, Union[Union[str, list], Any]]]:
        ...
        asm="\tandi reg_file[3],reg_file[0] ,0\n"	#clearing the bits in register x3
        asm+="\tandi reg_file[4],reg_file[0] ,0\n"	#clearing the bits in register x4
        asm+="\tandi reg_file[31] ,reg_file[0] ,0\n"	#clearing the bits in register x31
        ...
        for val in range(-10,20,2):
            asm += "\taddi reg_file[3] ,reg_file[3] ,val\n"
            asm += "\taddi reg_file[4] ,reg_file[4] ,7\n"
            asm += "\tadd reg_file[31] ,reg_file[3] ,reg_file[4]\n"
