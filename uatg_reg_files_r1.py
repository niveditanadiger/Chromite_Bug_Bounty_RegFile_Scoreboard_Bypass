...
class uatg_reg_files_r1(IPlugin):
    ...
    def generate_asm(self) -> List[Dict[str, Union[Union[str, list], Any]]]:
        ...
        asm="\taddi reg_file[1],reg_file[0] ,0\n"
        #to store zero in another register
        #used later for comparision
        
        for val in range(2,20,2):
            asm += "\taddi reg_file[0] ,reg_file[0] ,val\n"
            asm += "\tbne reg_file[0] ,reg_file[1] ,flag\n"
